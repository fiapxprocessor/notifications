defmodule Notifications.PromEx do
  @moduledoc """
  ...
  use PromEx, otp_app: :notifications
  ...
  def plugins do
    [
      ...
      Plugins.Application,
      Plugins.Beam,
      {Plugins.Phoenix, router: NotificationsWeb.Router, endpoint: NotificationsWeb.Endpoint},
      Plugins.Ecto,
      Plugins.Oban,
      ...
      # Notifications.Users.PromExPlugin
    ]
  end
  ...
  def dashboards do
    [
      ...
      # {:notifications, "/grafana_dashboards/user_metrics.json"}
    ]
  end
end
